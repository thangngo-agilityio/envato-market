...
// const transitionStyles: string = ['transition', 'duration-500'].join(' ');
...
const SideBarAllDevices = (): JSX.Element => (
  <header className='relative z-10 max-w-[320px] bg-white py-[60px] px-[70px] h-full hidden md:block'>
    <Button className='bg-sun w-10 h-10 flex justify-center items-center absolute top-0 right-md md:hidden'>
      <CloseSideBar width='9' height='12' />
    </Button>
